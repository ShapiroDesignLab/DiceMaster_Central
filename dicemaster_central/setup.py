...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'remote_logger.py = dicemaster_central.remote_logger:main',
            'dataset_loader_service.py = dicemaster_central.managers.dataset_loader:main',
            'usb_connector_checker.py = dicemaster_central.hw.usb_connector_checker:main',
            'notification_manager.py = dicemaster_central.managers.notifications:main',
            'dataset_manager.py = scripts.dataset_manager:main',
